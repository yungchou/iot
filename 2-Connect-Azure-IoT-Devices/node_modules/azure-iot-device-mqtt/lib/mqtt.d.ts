...
import { results, Message, X509, AuthenticationProvider, TransportConfig } from 'azure-iot-common';
 ...
 */
export declare class Mqtt extends EventEmitter implements Client.Transport {
    /**
     * @private
     */
    ...
    private _topicMethodSucbscribe;
    private _fsm;
    private _topics;
    /**
     * @private
    ...
    private _setupSubscription(topic, callback);
    private _removeSubscription(topic, callback);
