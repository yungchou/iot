...
var MqttWs = /** @class */ (function (_super) {
     ...
     */
    function MqttWs(authenticationProvider) {
    ...
    MqttWs.prototype._configureEndpoints = function (credentials) {
        _super.prototype._configureEndpoints.call(this, credentials);
        credentials.uri = 'wss://' + credentials.host + ':443/$iothub/websocket';
    };
    return MqttWs;
}(mqtt_1.Mqtt));
