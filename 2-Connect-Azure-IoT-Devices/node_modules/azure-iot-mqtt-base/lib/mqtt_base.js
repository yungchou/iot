...
var MqttBase = /** @class */ (function (_super) {
    ...
    function MqttBase(sdkVersionString, mqttprovider) {
        var _this = _super.call(this) || this;
        _this.mqttprovider = mqttprovider ? mqttprovider : require('mqtt');
        _this._sdkVersionString = sdkVersionString;
    ...
    MqttBase.prototype._connectClient = function (callback) {
        var _this = this;
        var uri = this._config.uri || 'mqtts://' + this._config.host;
        ...
        var options = {
            ...
            username: this._config.username ||
                (this._config.host + '/' + this._config.deviceId +
                    ...
                    '&' + azure_iot_common_1.endpoint.versionQueryString().substr(1)),
            reconnectPeriod: 0,
