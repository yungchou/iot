...
var FileUploadApi = /** @class */ (function () {
    ...
    FileUploadApi.prototype.getBlobSharedAccessSignature = function (blobName, done) {
        ...
        this._authenticationProvider.getDeviceCredentials(function (err, deviceCredentials) {
            ...
            var path = azure_iot_common_1.endpoint.devicePath(deviceCredentials.deviceId) + '/files' + azure_iot_common_1.endpoint.versionQueryString();
    ...
    FileUploadApi.prototype.notifyUploadComplete = function (correlationId, uploadResult, done) {
        ...
        this._authenticationProvider.getDeviceCredentials(function (err, deviceCredentials) {
            ...
            var path = azure_iot_common_1.endpoint.devicePath(deviceCredentials.deviceId) + '/files/notifications/' + encodeURIComponent(correlationId) + azure_iot_common_1.endpoint.versionQueryString();
