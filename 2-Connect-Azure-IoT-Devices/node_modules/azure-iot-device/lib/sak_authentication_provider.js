...
var SharedAccessKeyAuthenticationProvider = /** @class */ (function (_super) {
    ...
    SharedAccessKeyAuthenticationProvider.prototype._renewToken = function () {
        var _this = this;
        ...
        ```]*/
        var resourceUri = azure_iot_common_1.encodeUriComponentStrict(this._credentials.host + '/devices/' + this._credentials.deviceId);
        var sas = azure_iot_common_1.SharedAccessSignature.create(resourceUri, this._credentials.sharedAccessKeyName, this._credentials.sharedAccessKey, newExpiry);
        ...
        this._renewalTimeout = setTimeout(function () { return _this._renewToken(); }, nextRenewalTimeout);
